    ...
    <div class="col-lg-12">
        ...
        <div class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" value="{{ $productById->productPriceOld }}"  class="form-control" name="productPriceOld">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="productDescription" rows="5">{{ $productById->productDescription }}</textarea>
